        ...
        <div className="flex flex-wrap items-center 2xl:w-[1450px] xl:w-[1300px] w-11/12 mx-auto md:pl-4 xl:pr-16 xl:pl-16">
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-3/4 lg:w-unset">
              <span className="custom-block-subtitle">AI-Powered Automation</span>
              <h2 className="mt-6 mb-8 text-4xl lg:text-5xl custom-block-big-title">
                Custom AI agents that work 24/7
              </h2>
              <p className="mb-10 text-customGrayText leading-loose">
                We build intelligent AI agents and chatbots tailored to your business. 
                From customer support to lead generation, our solutions handle the 
              ...
              <ul className="mb-6 text-white">
                ...
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Telegram & Discord bot development</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Multi-platform AI assistants</span>
                </li>
              </ul>
            </div>
          </div>
